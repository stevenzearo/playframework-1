...
class PlayAppWithFailingTestsIntegrationTest extends PlayMultiVersionIntegrationTest {
    ...
    def "reports failing run play app tests"() {
        ...
        result.output.contains("FailingApplicationSpec > failingTest FAILED")
        result.output.contains("FailingIntegrationSpec > failingTest FAILED")
        ...
        testResult.testClass("FailingIntegrationSpec")
                .assertTestCount(1, 1, 0)
        testResult.testClass("FailingApplicationSpec")
